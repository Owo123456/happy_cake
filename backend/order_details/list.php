    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-left">
          ...
          <a href="../customer_orders/list.php" class="btn btn-outline-primary m-2">回訂單列表</a>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
          <table class="table">
            ...
            <tbody>
              ...
              <tr>
                <td><img src="../../uploads/products/<?php echo $order_details['picture']; ?>" alt="$order_details['name']" width="150px" height="auto"></td>
                <td><?php echo $order_details['name']; ?></td>
                <td>$NT <?php echo $order_details['price']; ?></td>
                <?php if( $order_details['status'] == 2){ ?>
                <td>$NT <?php echo $order_details['sale']; ?></td>
                <?php }else{ ?>
                <td>無特價</td>
                <?php } ?>
                <td><?php echo $order_details['quantity']; ?></td>
                <?php if( $order_details['status'] == 2){ ?>
                <td>$NT <?php $subtotal = $order_details['sale'] * $order_details['quantity']; echo $subtotal;?></td>
                <?php }else{ ?>
                <td>$NT <?php $subtotal = $order_details['price'] * $order_details['quantity']; echo $subtotal;?></td>
                <?php } ?>
