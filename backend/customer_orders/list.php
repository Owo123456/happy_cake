  ...
  <div class="py-5 text-center">
    <div class="container">
      ...
      <div class="row">
        ...
        <a href="list.php" class="btn btn-outline-primary ">全部訂單</a>
          <select class="form-control mt-2 mb-2" id="status" name="status">
              <option value="0" <?php if(isset($_GET['status']) && $_GET['status'] == 0) echo "selected"; ?>>新訂單</option>
              <option value="1" <?php if(isset($_GET['status']) && $_GET['status'] == 1) echo "selected"; ?>>待出貨訂單</option>
              <option value="2" <?php if(isset($_GET['status']) && $_GET['status'] == 2) echo "selected"; ?>>已出貨訂單</option>
              <option value="3" <?php if(isset($_GET['status']) && $_GET['status'] == 3) echo "selected"; ?>>已完成訂單</option>
              <option value="99" <?php if(isset($_GET['status']) && $_GET['status'] == 99) echo "selected"; ?>>已取消訂單</option>
          </select>
        </div>    
      </div>
      <div class="row">
          ...
          <table class="table">
            ...
            <?php 
              ...
              <tr>
                ...
                <td class="text-center"><?php echo $customer_orders['order_date']; ?></td>
                ...
                <td class="text-right"><?php echo $customer_orders['total']; ?></td>
                <td class="text-center"><?php echo $customer_orders['status']; ?>
