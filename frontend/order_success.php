...
<?php
  ...
  for($i = 0; $i < count($_SESSION['Cart']); $i++){
    $sql2= "INSERT INTO order_details (customer_orderID, productID, picture, name, price, status, sale, quantity, created_at) VALUES ( :customer_orderID, :productID, :picture, :name, :price, :status, :sale, :quantity, :created_at)";
    ...
    $sth2 ->bindParam(":status", $_SESSION['Cart'][$i]['status'], PDO::PARAM_STR);
    $sth2 ->bindParam(":sale", $_SESSION['Cart'][$i]['sale'], PDO::PARAM_STR);
                    ...
                    <div class="row" id="error-page">
                        <div class="col-sm-6 col-sm-offset-3">
                            <div class="box">
                                ...
                                <p class="text-center">您已成功完成購物，您可前往<a href="customer-orders.php">我的訂單</a>查詢出貨進度或<a href="product_list.php">繼續購物</a></p>
